...
if [ ! -r kernel-source-2.6.34.7-0.5.1.src.rpm ]
then
    wget http://download.opensuse.org/update/11.3/rpm/src/kernel-source-2.6.34.7-0.5.1.src.rpm || die "Can't download source package."
fi
rpm --checksig kernel-source-2.6.34.7-0.5.1.src.rpm || die "Can't verify signature."
rpm -ivh kernel-source-2.6.34.7-0.5.1.src.rpm || die "Can't install source package."

if [ ! -r kernel-default-2.6.34.7-0.5.1.nosrc.rpm ]
then
    wget http://download.opensuse.org/update/11.3/rpm/src/kernel-default-2.6.34.7-0.5.1.nosrc.rpm || die "Can't download source package."
fi
rpm --checksig kernel-default-2.6.34.7-0.5.1.nosrc.rpm || die "Can't verify signature."
rpm -ivh kernel-default-2.6.34.7-0.5.1.nosrc.rpm || die "Can't install source package."

cd /usr/src/packages/SOURCES/ || die "Can't chdir to /usr/src/packages/SOURCES/ ."
if [ ! -r ccs-patch-1.7.2-20101122.tar.gz ]
then
    wget http://sourceforge.jp/frs/redir.php?f=/tomoyo/43375/ccs-patch-1.7.2-20101122.tar.gz || die "Can't download patch."
fi
