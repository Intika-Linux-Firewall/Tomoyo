...
%define release 8.15%{?dist}_tomoyo_1.6.0
...
BuildPreReq: gnupg
%endif
BuildRequires: gcc >= 3.4.2, binutils >= 2.12, asianux-rpm-config
%if %{buildheaders}
...
#
# Asianux Patch Start 100000 - 999999
#
#
# 100100 - 100199   x86(-64)
#
Patch100100: linux-2.6.9-mmconfig-tlb-race-fix.patch
Patch100101: linux-2.6.9-x86_64-mmconfig-fix.patch
# swsusp resume fix on x86_64
Patch100102: linux-2.6-x86_64-suspend-use-normal-page.patch
# hugetlb update
Patch100104: linux-2.6.18-hugetlb-page_to_nid.patch
Patch100105: linux-2.6-hugetlb-free-alloc-race-fix.patch
...
# asianux compile
Patch100200: linux-2.6.9-asianux-compileh.patch
Patch100201: linux-2.6.18-module-sig-fix.patch

#
# Ext2/Ext3 fixes
#
Patch100300: linux-2.6.9-commit-superblock-before-panicking-fix.patch

#
# Reserved For New Driver 101000
#

#
# Driver Update
#
Patch102011: linux-2.6.20-tlclk-bug-fix-misc-fixes.patch
Patch102012: linux-2.6.20-tlclk-backport.patch
Patch102014: linux-2.6.18-pcie-warning-message-fix.patch
Patch102015: linux-2.6.18-pirq-add-ICH9-fix.patch

# E1000
Patch102020: linux-2.6.9-e1000-7.2.9-k2.patch
Patch102021: linux-2.6.9-e1000-7.2.9-k2-porting.patch
Patch102022: linux-2.6.9-e1000-7.2.9-80003es2lan-fix.patch
Patch102023: linux-2.6.9-e1000-7.2.9-ERT-fix.patch
Patch102024: linux-2.6.9-e1000-7.2.9-phy-reg-race-fix.patch
Patch102025: linux-2.6.9-e1000-7.2.9-tso-cleanup-and-82544-fix.patch

# IDE
Patch102030: linux-2.6.9-ide_noraid.patch
Patch102031: linux-2.6.9-sis-ide.patch

#
# SCSI
#
Patch102040: linux-2.6.18-scsi_device_lookup-fix.patch
# aic79xx
Patch102050: linux-2.6.9-aic79xx-ignore_hostraid.patch
Patch102051: linux-2.6-aic79xx-29320LPE-limit-4g.patch
Patch102052: linux-2.6.9-aic79xx-ignore_hostraid-default-1.patch
# megaraid_sas
Patch102100: linux-2.6.20-megaraid_sas-03.05-sync_cache-fix.patch

# r8169
Patch102500: linux-2.6.19-r8169-update.patch
Patch102501: linux-2.6.19-r8169-backport.patch
# sky2
Patch102550: linux-2.6.18-sky2-1.6.patch
# chelsio
Patch102600: linux-2.6.18_chelsio-add-support-for-other-10G-boards.patch
Patch102601: linux-2.6.18_chelsio-backport-for-other-10G.patch

#
# Others
#
Patch103000: linux-2.6.9-usb-ohci-hub-fix.patch
Patch103002: linux-2.6.9-nls-Japanese.patch
# ipv6 getsockopt fixes
Patch103004: linux-2.6.18-ipv6_getsockopt_sticky-fixes1.patch
...
# 2.6.18.8
Patch103012: linux-2.6.18.8-port-for-axs3.patch
Patch103013: linux-2.6.18.8-port-abi-fix.patch
# hw_random/intel-rng fixes
Patch103014: linux-2.6.18-hw_random-init-order-fix.patch
Patch103015: linux-2.6.18-hw_random-use-device-macro.patch
# sort speedup
Patch103017: linux-2.6.18-sort-speedup.patch
# improve list_debug
Patch103018: linux-2.6.18-list_debug-more.patch
# kref fixes
Patch103019: linux-2.6.18-kref-fix1.patch
Patch103020: linux-2.6.18-kref-fix2.patch
# ppc64 needs bigger slab to allocate SKB_MAX_ALLOC
Patch103021: linux-2.6-ppc64-alloc-bigger-kmalloc.patch
# intel-rng fixes
Patch103022: linux-2.6-intel-rng-fix-deadlock-in-smp_call_function-fix.patch
Patch103023: linux-2.6-intel-rng-message-fix.patch
# tg3 update
Patch103024: linux-2.6-tg3-3.72.patch
Patch103025: linux-2.6-tg3-3.72-backport.patch
Patch103026: linux-2.6-tg3-dont-use-slower-clock.patch
Patch103027: linux-2.6-tg3-use-contants-test1.patch
Patch103028: linux-2.6-tg3-dell-5906-fix.patch
# iscsi trivial fixes
Patch103029: linux-2.6-scsi_transport_iscsi-newline-fix.patch
Patch103030: linux-2.6-scsi_transport_iscsi-atomic-fix.patch
# ia64 _PDC fixes
Patch103031: linux-2.6-ia64-acpi_pdc-initialize-fix.patch
Patch103032: linux-2.6-ia64-acpi_pdc-use-pdc_intel_h.patch
# Fix linux-2.6-mm-reduce-madv_dontneed-contention
Patch103033: linux-2.6-mm-reduce-madv_dontneed-contention-fix.patch
# Fix linux-2.6-mm-prevent-oom-kill-of-unkillable-children
Patch103034: linux-2.6-mm-prevent-oom-kill-of-unkillable-children-fix.patch
# Fix sata super update
Patch103036: linux-2.6-sata-spd-init-fix.patch
Patch103037: linux-2.6-sata-ahci-fix-port_impl.patch
Patch103038: linux-2.6-sata-eh_pending-fix.patch
# scsi scan fix
Patch103039: linux-2.6-scsi-scan-refcnt-breakage-fix.patch
# sd class init order fix
Patch103040: linux-2.6-scsi-sd-class-init-order-fix.patch
# sr fix error code check
Patch103041: linux-2.6-scsi-sr-error-type-fix.patch
# oom deadlock fix
Patch103042: linux-2.6-oom_kill-deadlock-fix.patch
# e1000e
Patch103043: linux-2.6-e1000e-support.patch
Patch103044: linux-2.6-e1000e-cleanup.patch
Patch103045: linux-2.6-e1000e-phy-reg-race-fix.patch
Patch103046: linux-2.6-e1000e-timer-race-fix.patch
Patch103047: linux-2.6-e1000e-revert-itr-default.patch
Patch103048: linux-2.6-e1000e-support-only-pcie.patch
Patch103049: linux-2.6-e1000e-rename-to-e1000e.patch
# ocfs2-1.2.6 from oss.oracle.com
Patch103050: linux-2.6-ocfs2-1.2.6-from-oracle.patch
# igrab race fix
Patch103051: linux-2.6-igrab-clear_inode-race-fix.patch
# compat semctl fix
Patch103052: linux-2.6-compat-semctl-efault-fix.patch
# get_devres_head null check
Patch103053: linux-2.6-get_devres_head-null-check.patch
# e1000 remove pcie support
...
Patch200001: linux-2.6-revoke-special-mmap-handling-vs-fault-vs-invalidate.patch
Patch200002: linux-2.6-revoke-core-code.patch
Patch200003: linux-2.6-revoke-core-code-fix-zero-length-kmalloc.patch
Patch200004: linux-2.6-revoke-core-free_fset-fix.patch
Patch200005: linux-2.6-revoke-core-f_op-init-fix.patch
Patch200006: linux-2.6-revoke-core-filp-refcnt-fix.patch
Patch200007: linux-2.6-revoke-core-task-mm-fix.patch
Patch200008: linux-2.6-revoke-support-for-ext2-and-ext3.patch
...
%define __find_requires /usr/lib/rpm/asianux/find-requires kernel
...
you are so inclined (and you know what you're doing). This package
...
patch -sp1 < patches/ccs-patch-2.6.18-8.15AX.diff
...
%if %{buildsource}
# Save for buildsource
cd ..
if [ -d linux-source ]; then
  # Just in case we ctrl-c'd a prep already
  rm -rf deleteme-source
  # Move away the stale away, and delete in background.
  mv linux-source deleteme-source
  rm -rf deleteme-source &
fi
cp -rl linux-%{kversion}.%{_target_cpu} linux-source
%endif
...
# clean up the source tree so that it is ready for users to build
# their own kernel
make -s mrproper
# copy the source over
tar cf - . | tar xf - -C $RPM_BUILD_ROOT/usr/src/linux-%{KVERREL}

# set the EXTRAVERSION to <version>custom, so that people who follow a
# kernel building howto don't accidentally overwrite their currently
# working moduleset and hose their system
...
if [ "$HARDLINK" != "no" -a -x /usr/sbin/hardlink ] ; then
  ...
  /usr/bin/find . -type f -not -size 0 | while read f; do hardlink -c /usr/src/kernels/*FC*/$f $f ; done
  popd > /dev/null
fi
