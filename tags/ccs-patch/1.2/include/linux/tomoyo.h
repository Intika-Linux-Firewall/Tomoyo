...
int FindNextDomain(const char *original_name, struct domain_info **next_domain, char __user * __user *argv);
#endif
...
#else
static inline int CheckFilePerm(const char *filename, const u16 perm, const int is_realpath, const char *operation) { return 0; }
...
#else
static inline int CheckArgv0Perm(const char *filename, const char *argv0) { return 0; }
#endif
...
#define MAKE_ACL_HASH(x)     ((u16) (x))
#define GET_ACL_HASH(x)      ((u16) (x))
...
#define TYPE_IPv4_NETWORK_ACL 103
