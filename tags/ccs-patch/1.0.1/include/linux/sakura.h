...
#define SAKURA_DISABLE_LOCAL_EXECVE                  1  /* current program won't call execve()                             */
#define SAKURA_DISABLE_LOCAL_CHROOT                  2  /* current program won't call chroot()                             */
#define SAKURA_DISABLE_LOCAL_PIVOTROOT               4  /* current program won't call pivot_root()                         */
#define SAKURA_DISABLE_LOCAL_MOUNT                   8  /* current program won't call mount()                              */
#define SAKURA_DISABLE_LOCAL_EUID0                  16  /* current program won't become euid = 0 after becoming euid != 0. */
#define SAKURA_DISABLE_LOCAL_EUID0_DISABLED         32  /* current program won't become euid = 0 from now on.              */
#define SAKURA_LOCAL_DISABLE_MASK                   63  /* Bitwised OR for the above capabilities.                         */
#define SAKURA_DISABLE_INHERITABLE_CHROOT           64  /* current process won't call chroot()                             */
#define SAKURA_DISABLE_INHERITABLE_PIVOTROOT       128  /* current process won't call pivot_root()                         */
#define SAKURA_DISABLE_INHERITABLE_MOUNT           256  /* current process won't call mount()                              */
#define SAKURA_DISABLE_INHERITABLE_EUID0           512  /* current process won't become euid = 0 after becoming euid != 0. */
#define SAKURA_DISABLE_INHERITABLE_EUID0_DISABLED 1024  /* current process won't become euid = 0 from now on.              */
