...
src_install() {
	...
	doexe makesyaoranconf candy chaplet checktoken gettoken groovy honey mailauth proxy timeauth falsh ccs-notifyd audit-exec-param convert-exec-param ccs-editpolicy-agent
	exeopts -m 4711 -o root -g root
	doexe force-logout
