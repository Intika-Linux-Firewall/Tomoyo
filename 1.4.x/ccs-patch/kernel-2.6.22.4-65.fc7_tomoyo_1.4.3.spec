...
%define fedora_build %(R="$Revision: 1.3325 $"; R="${R%% \$}"; R="${R##: 1.}"; expr $R - %{fedora_cvs_origin})
...
sed -i -e 's:EXTRAVERSION =.*:EXTRAVERSION = .4-65.fc7:' -- Makefile
patch -sp1 < ccs-patch-2.6.22.4-65.fc7.txt
