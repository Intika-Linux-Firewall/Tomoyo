...
if [ ! -r kernel-2.6.18-128.1.16.el5.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/centos/5.3/updates/SRPMS/kernel-2.6.18-128.1.16.el5.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.18-128.1.16.el5.src.rpm || die "Can't install source package."
...
--- kernel-2.6.spec	2009-06-30 18:43:04.000000000 +0900
+++ kernel-2.6.spec	2009-07-01 15:47:51.000000000 +0900
@@ -66,7 +66,7 @@
