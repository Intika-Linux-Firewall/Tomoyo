...
if [ ! -r kernel-2.6.18-128.4.1.el5.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/centos/5.3/updates/SRPMS/kernel-2.6.18-128.4.1.el5.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.18-128.4.1.el5.src.rpm || die "Can't install source package."
...
--- kernel-2.6.spec	2009-08-05 08:54:34.000000000 +0900
+++ kernel-2.6.spec	2009-08-08 00:21:19.000000000 +0900
@@ -66,7 +66,7 @@
