...
if [ ! -r kernel-2.6.30.10-105.2.16.fc11.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/fedora/updates/11/SRPMS/kernel-2.6.30.10-105.2.16.fc11.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.30.10-105.2.16.fc11.src.rpm || die "Can't install source package."
...
--- ccs-kernel.spec	2010-02-05 00:31:05.000000000 +0900
+++ ccs-kernel.spec	2010-02-06 21:15:28.392792040 +0900
@@ -15,7 +15,7 @@
