...
if [ ! -r kernel-2.6.27.38-170.2.113.fc10.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/fedora/updates/10/SRPMS/kernel-2.6.27.38-170.2.113.fc10.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.27.38-170.2.113.fc10.src.rpm || die "Can't install source package."
...
--- kernel.spec	2009-11-05 07:14:20.000000000 +0900
+++ kernel.spec	2009-11-07 09:56:33.000000000 +0900
@@ -15,7 +15,7 @@
