...
then
    wget -O ccs-patch-2.6.24-ubuntu-8.04p1.diff 'http://svn.sourceforge.jp/cgi-bin/viewcvs.cgi/*checkout*/trunk/1.6.x/ccs-patch/patches/ccs-patch-2.6.24-ubuntu-8.04.diff?root=tomoyo'
fi
