...
if [ ! -r kernel-2.6.9-89.0.16.EL.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/centos/4.8/updates/SRPMS/kernel-2.6.9-89.0.16.EL.src.rpm || die "Can't download source package."
fi
...
--- kernel-2.6.spec	2009-11-04 06:57:13.000000000 +0900
+++ kernel-2.6.spec	2009-11-05 11:16:01.000000000 +0900
@@ -27,7 +27,7 @@
 # that the kernel isn't the stock distribution kernel, for example by
 # adding some text to the end of the version number.
 #
-%define release 89.0.16.EL
+%define release 89.0.16.EL_tomoyo_1.6.8p1
 %define sublevel 9
