...
then
    wget -O ccs-patch-2.6.9-centos-4.7.diff 'http://svn.sourceforge.jp/cgi-bin/viewcvs.cgi/*checkout*/trunk/1.6.x/ccs-patch/patches/ccs-patch-2.6.9-centos-4.7.diff?root=tomoyo' || die "Can't download patch."
fi
...
+%define release 78.EL_tomoyo_1.6.4
 %define sublevel 9
