...
EOF
mv kernel-default.spec kernel-2.6.18.8-0.9-default_tomoyo_1.6.0.spec || die "Can't rename spec file."
echo ""
echo ""
echo ""
echo "Edit /tmp/kernel-2.6.18.8-0.9-default_tomoyo_1.6.0.spec if needed, and run"
echo "rpmbuild -bb /tmp/kernel-2.6.18.8-0.9-default_tomoyo_1.6.0.spec"
