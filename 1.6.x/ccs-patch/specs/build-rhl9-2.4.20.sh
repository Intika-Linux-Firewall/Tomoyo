...
+%define release 46.9.legacy_tomoyo_1.6.1
 %define sublevel 20
...
EOF
mv kernel-2.4.spec kernel-2.4.20-46.9.legacy_tomoyo_1.6.1.spec || die "Can't rename spec file."
echo ""
echo ""
echo ""
echo "Edit /tmp/kernel-2.4.20-46.9.legacy_tomoyo_1.6.1.spec if needed, and run"
echo "rpmbuild -bb /tmp/kernel-2.4.20-46.9.legacy_tomoyo_1.6.1.spec"
