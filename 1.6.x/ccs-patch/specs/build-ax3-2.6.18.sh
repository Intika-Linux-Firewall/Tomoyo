...
if [ ! -r kernel-2.6.18-53.14AXS3.src.rpm ]
then
    wget http://ftp.miraclelinux.com/pub/Asianux/Server/3.0/updates/src/kernel-2.6.18-53.14AXS3.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.18-53.14AXS3.src.rpm || die "Can't install source package."
...
--- kernel-2.6.spec	2008-11-14 11:14:21.000000000 +0900
+++ kernel-2.6.spec	2008-12-11 16:36:36.000000000 +0900
@@ -64,7 +64,7 @@
 %define sublevel 18
 %define kversion 2.6.%{sublevel}
 %define rpmversion 2.6.%{sublevel}
-%define release 53.14%{?dist}
+%define release 53.14%{?dist}_tomoyo_1.6.5
