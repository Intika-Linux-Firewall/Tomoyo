...
apt-get build-dep kernel-image-2.6.8-4-686-smp
apt-get source kernel-image-2.6.8-4-686-smp

# Download TOMOYO Linux patches.
cd kernel-image-2.6.8-i386-2.6.8/
...
patch -p1 < patches/ccs-patch-2.6.8-17sarge1.diff
