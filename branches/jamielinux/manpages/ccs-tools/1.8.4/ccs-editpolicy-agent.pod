...
B<ccs-editpolicy-agent> I<listen_ip:listen_port>

=head1 DESCRIPTION

This program is an agent for B<ccs-editpolicy>, B<ccs-loadpolicy>, B<ccs-savepolicy>, B<ccs-pstree>, B<ccs-queryd>, and B<ccs-auditd>.
...
Before this program can be invoked, you must register it in F</proc/ccs/manager>.
...
B<ccs-editpolicy>(8), B<ccs-loadpolicy>(8), B<ccs-savepolicy>(8), B<ccs-pstree>(8), B<ccs-queryd>(8), B<ccs-auditd>(8)
