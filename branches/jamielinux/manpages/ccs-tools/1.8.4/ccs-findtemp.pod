...
ccs-findtemp - detect temporary pathnames in TOMOYO Linux policy

=head1 SYNOPSIS

B<ccs-findtemp> [I<option>]
...
=item B<Search for nonexistent pathnames in domain policy>
