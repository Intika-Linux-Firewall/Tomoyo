...
then
    wget -O ccs-patch-2.6.18-centos-5.3-20110614.diff 'http://sourceforge.jp/projects/tomoyo/svn/view/branches/ccs-patch-2.6.18-centos-5.3.diff?revision=5185&root=tomoyo' || die "Can't download patch."
fi
