...
static struct test_struct {
	...
	{ setup_test_file, test_file_open_1, cleanup_test_file, "create", "allow_create /tmp/testfile1 if task.uid=path1.parent.uid" },
	...
	{ setup_test_file, test_file_open_3, cleanup_test_file, "create", "allow_create /tmp/testfile3 if task.uid=path1.parent.uid" },
	...
	{ setup_test_file, test_file_open_5, cleanup_test_file, "create", "allow_create /tmp/testfile5 if task.uid=path1.parent.uid" },
	...
	{ setup_test_file, test_file_open_7, cleanup_test_file, "create", "allow_create /tmp/testfile7 if task.uid=path1.parent.uid" },
	...
	{ setup_test_file, test_file_open_9, cleanup_test_file, "create", "allow_create /tmp/testfile9 if task.uid=path1.parent.uid" },
	...
	{ setup_test_file, test_file_open_11, cleanup_test_file, "create", "allow_create /tmp/testfile11 if task.uid=path1.parent.uid" },
	...
	{ setup_test_file, test_file_open_13, cleanup_test_file, "create", "allow_create /tmp/testfile13 if task.uid=path1.parent.uid" },
	...
	{ setup_test_file, test_file_open_15, cleanup_test_file, "create", "allow_create /tmp/testfile15 if task.uid=path1.parent.uid" },
	...
	{ setup_test_file, test_file_open_17, cleanup_test_file, "create", "allow_create /tmp/testfile17 if task.uid=path1.parent.uid" },
	...
	{ setup_test_file, test_file_open_19, cleanup_test_file, "create", "allow_create /tmp/testfile19 if task.uid=path1.parent.uid" },
	...
	{ setup_test_file, test_file_open_21, cleanup_test_file, "create", "allow_create /tmp/testfile21 if task.uid=path1.parent.uid" },
	...
	{ setup_test_file, test_file_open_23, cleanup_test_file, "create", "allow_create /tmp/testfile23 if task.uid=path1.parent.uid" },
