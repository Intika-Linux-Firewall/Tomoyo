...
static void make_profile(void)
{
	static const char full_profile_text[] = {
		...
		"0-MAC_MODE_DISABLED={ "
		"execute open create unlink mkdir rmdir mkfifo mksock "
		"truncate symlink rewrite mkblock mkchar link rename chmod "
		"chown chgrp ioctl chroot mount umount pivot_root env network "
		"signal capability::inet_tcp_create "
		"capability::inet_tcp_listen capability::inet_tcp_connect "
		"capability::use_inet_udp capability::use_inet_ip "
		"capability::use_route capability::use_packet "
		"capability::SYS_MOUNT capability::SYS_UMOUNT "
		"capability::SYS_REBOOT capability::SYS_CHROOT "
		"capability::SYS_KILL capability::SYS_VHANGUP "
		"capability::SYS_TIME capability::SYS_NICE "
		"capability::SYS_SETHOSTNAME capability::use_kernel_module "
		"capability::create_fifo capability::create_block_dev "
		"capability::create_char_dev capability::create_unix_socket "
		"capability::SYS_LINK capability::SYS_SYMLINK "
		"capability::SYS_RENAME capability::SYS_UNLINK "
		"capability::SYS_CHMOD capability::SYS_CHOWN "
		"capability::SYS_IOCTL capability::SYS_KEXEC_LOAD "
		"capability::SYS_PIVOT_ROOT capability::SYS_PTRACE "
		"capability::conceal_mount }\n"
		"0-MAC_MODE_LEARNING={ }\n"
		"0-MAC_MODE_PERMISSIVE={ }\n"
		"0-MAC_MODE_ENFORCING={ }\n"
		"0-NO_AUDIT_GRANT_LOG={ }\n"
		"0-NO_AUDIT_REJECT_LOG={ }\n"
		...
		"capability::SYS_PIVOT_ROOT capability::SYS_PTRACE "
		"capability::conceal_mount }\n"
		"1-MAC_MODE_PERMISSIVE={ }\n"
		"1-MAC_MODE_ENFORCING={ }\n"
		"1-NO_AUDIT_GRANT_LOG={ }\n"
		"1-NO_AUDIT_REJECT_LOG={ }\n"
		...
		"1-PRINT_VIOLATION=disabled\n"
		"2-COMMENT=-----Permissive Mode-----\n"
		"2-MAC_MODE_DISABLED={ }\n"
		"2-MAC_MODE_LEARNING={ }\n"
		"2-MAC_MODE_PERMISSIVE={ "
		"execute open create unlink mkdir rmdir mkfifo mksock "
		"truncate symlink rewrite mkblock mkchar link rename chmod "
		"chown chgrp ioctl chroot mount umount pivot_root env network "
		"signal capability::inet_tcp_create "
		...
		"capability::SYS_PIVOT_ROOT capability::SYS_PTRACE "
		"capability::conceal_mount }\n"
		"2-MAC_MODE_ENFORCING={ }\n"
		"2-NO_AUDIT_GRANT_LOG={ }\n"
		"2-NO_AUDIT_REJECT_LOG={ }\n"
		...
		"3-MAC_MODE_DISABLED={ }\n"
		"3-MAC_MODE_LEARNING={ }\n"
		"3-MAC_MODE_PERMISSIVE={ }\n"
		"3-MAC_MODE_ENFORCING={ "
		"execute open create unlink mkdir rmdir mkfifo mksock "
		"truncate symlink rewrite mkblock mkchar link rename chmod "
		"chown chgrp ioctl chroot mount umount pivot_root env network "
		"signal capability::inet_tcp_create "
		...
		"capability::SYS_PIVOT_ROOT capability::SYS_PTRACE "
		"capability::conceal_mount }\n"
		"3-NO_AUDIT_GRANT_LOG={ }\n"
		"3-NO_AUDIT_REJECT_LOG={ }\n"
	...
	static const char file_only_profile_text[] = {
		...
		"1-COMMENT=-----Learning Mode-----\n"
		"1-MAC_MODE_DISABLED={ "
		"env network signal capability::inet_tcp_create "
		"capability::inet_tcp_listen capability::inet_tcp_connect "
		"capability::use_inet_udp capability::use_inet_ip "
		"capability::use_route capability::use_packet "
		"capability::SYS_MOUNT capability::SYS_UMOUNT "
		...
		"execute open create unlink mkdir rmdir mkfifo mksock "
		"truncate symlink rewrite mkblock mkchar link rename chmod "
		"chown chgrp ioctl chroot mount umount pivot_root }\n"
		"1-MAC_MODE_PERMISSIVE={ }\n"
		"1-MAC_MODE_ENFORCING={ }\n"
		"1-NO_AUDIT_GRANT_LOG={ }\n"
		"1-NO_AUDIT_REJECT_LOG={ }\n"
