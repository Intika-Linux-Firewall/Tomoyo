...
struct ccs_editpolicy_directive ccs_directives[CCS_MAX_DIRECTIVE_INDEX] = {
	...
	[CCS_DIRECTIVE_ALLOW_EXECUTE]    = { "file execute", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_READ]       = { "file read", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_WRITE]      = { "file write", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_CREATE]     = { "file create", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_UNLINK]     = { "file unlink", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_MKDIR]      = { "file mkdir", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_RMDIR]      = { "file rmdir", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_MKFIFO]     = { "file mkfifo", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_MKSOCK]     = { "file mksock", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_MKBLOCK]    = { "file mkblock", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_MKCHAR]     = { "file mkchar", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_TRUNCATE]   = { "file truncate", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_SYMLINK]    = { "file symlink", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_LINK]       = { "file link", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_RENAME]     = { "file rename", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_APPEND]     = { "file append", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_TRANSIT]    = { "file transit", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_IOCTL]      = { "file ioctl", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_SIGNAL]     = { "ipc signal", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_NETWORK]    = { "network", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_ENV]        = { "misc env", NULL, 0, 0 },
	[CCS_DIRECTIVE_ADDRESS_GROUP]    = { "address_group", NULL, 0, 0 },
	[CCS_DIRECTIVE_AGGREGATOR]       = { "aggregator", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_CAPABILITY] = { "capability", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_CHROOT]     = { "file chroot", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_MOUNT]      = { "file mount", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_PIVOT_ROOT] = { "file pivot_root", NULL, 0, 0 },
	[CCS_DIRECTIVE_DENY_AUTOBIND]    = { "deny_autobind", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_UNMOUNT]    = { "file unmount", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_CHMOD]      = { "file chmod", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_CHOWN]      = { "file chown", NULL, 0, 0 },
	[CCS_DIRECTIVE_ALLOW_CHGRP]      = { "file chgrp", NULL, 0, 0 },
