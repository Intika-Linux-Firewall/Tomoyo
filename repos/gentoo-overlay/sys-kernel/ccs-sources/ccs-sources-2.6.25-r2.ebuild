...
CCS_TGP_SRC="mirror://sourceforge.jp/tomoyo/30297/${CCS_TGP}.tar.gz http://svn.sourceforge.jp/cgi-bin/viewcvs.cgi/*checkout*/trunk/1.6.x/ccs-patch/patches/ccs-patch-2.6.25.diff?rev=1226&root=tomoyo"
...
src_unpack() {
	...
	mv ../distdir/ccs-patch-2.6.25.diff\?rev=1226\&root=tomoyo patches/ccs-patch-2.6.25.diff || die
