...
if [ ! -r kernel-2.6.25.14-69.fc8.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/fedora/updates/8/SRPMS/kernel-2.6.25.14-69.fc8.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.25.14-69.fc8.src.rpm || die "Can't install source package."
...
then
    wget -O ccs-patch-2.6.25.14-69.fc8.diff 'http://svn.sourceforge.jp/cgi-bin/viewcvs.cgi/*checkout*/trunk/1.5.x/ccs-patch/patches/ccs-patch-2.6.25.14-69.fc8.diff?root=tomoyo' || die "Can't download patch."
fi

cd /tmp/ || die "Can't chdir to /tmp/ ."
cp -p /usr/src/redhat/SPECS/kernel.spec . || die "Can't copy spec file."
patch << "EOF" || die "Can't patch spec file."
--- kernel.spec	2008-08-05 02:36:05.000000000 +0900
+++ kernel.spec	2008-08-14 10:51:06.000000000 +0900
@@ -12,7 +12,7 @@
