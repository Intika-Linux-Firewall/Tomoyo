#! /bin/sh
#
# This is a kernel build script for Fedora 9's 2.6.26 kernel.
#
...
if [ ! -r ccs-patch-2.6.26-fedora-9.diff ]
then
    wget -O ccs-patch-2.6.26-fedora-9.diff 'http://svn.sourceforge.jp/cgi-bin/viewcvs.cgi/*checkout*/trunk/1.5.x/ccs-patch/patches/ccs-patch-2.6.26-fedora-9.diff?root=tomoyo' || die "Can't download patch."
fi
...
+patch -sp1 < %_sourcedir/ccs-patch-2.6.26-fedora-9.diff
+
 %endif
