...
if [ ! -r kernel-2.6.27.19-170.2.35.fc10.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/fedora/development/source/SRPMS/kernel-2.6.27.19-170.2.35.fc10.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.27.19-170.2.35.fc10.src.rpm || die "Can't install source package."
...
--- kernel.spec	2009-02-24 02:38:31.000000000 +0900
+++ kernel.spec	2009-03-03 09:41:31.000000000 +0900
@@ -12,7 +12,7 @@
