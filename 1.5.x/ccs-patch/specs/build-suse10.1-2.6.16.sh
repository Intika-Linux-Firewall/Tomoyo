...
EOF
mv kernel-default.spec kernel-2.6.16.54-0.2.5-default_tomoyo_1.5.4.spec || die "Can't rename spec file."
echo ""
echo ""
echo ""
echo "Edit /tmp/kernel-2.6.16.54-0.2.5-default_tomoyo_1.5.4.spec if needed, and run"
echo "rpmbuild -bb /tmp/kernel-2.6.16.54-0.2.5-default_tomoyo_1.5.4.spec"
