...
tar -zxf /usr/src/rpm/SOURCES/ccs-patch-1.5.5-20090202.tar.gz config.ccs || die "Can't extract patch."
...
tar -zxf /usr/src/rpm/SOURCES/ccs-patch-1.5.5-20090202.tar.gz || die "Can't extract patch."
