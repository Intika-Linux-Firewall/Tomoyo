...
if [ ! -r kernel-2.6.18-92.1.17.el5.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/centos/5.2/updates/SRPMS/kernel-2.6.18-92.1.17.el5.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.18-92.1.17.el5.src.rpm || die "Can't install source package."
...
--- kernel-2.6.spec	2008-11-04 22:27:30.000000000 +0900
+++ kernel-2.6.spec	2008-11-06 09:24:06.000000000 +0900
@@ -66,7 +66,7 @@
