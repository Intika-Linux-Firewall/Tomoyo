...
%define fedora_build %(R="$Revision: 1.3345 $"; R="${R%% \$}"; R="${R##: 1.}"; expr $R - %{fedora_cvs_origin})
...
sed -i -e 's:EXTRAVERSION =.*:EXTRAVERSION = .7-85.fc7:' -- Makefile
patch -sp1 < /usr/src/ccs-patch-2.6.22.7-85.fc7.txt
