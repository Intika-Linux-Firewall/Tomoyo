...
then
    wget -O ccs-patch-2.6.18-centos-5.6-1.8.0-20110114.diff 'http://sourceforge.jp/projects/tomoyo/svn/view/trunk/1.8.x/ccs-patch/patches/ccs-patch-2.6.18-centos-5.6.diff?root=tomoyo&revision=4362&content-type=text%2Fplain'
fi
