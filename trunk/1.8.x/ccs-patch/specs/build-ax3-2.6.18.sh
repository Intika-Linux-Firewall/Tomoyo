...
then
    wget -O ccs-patch-2.6.18-asianux-3-1.8-20111018.diff 'http://svn.sourceforge.jp/cgi-bin/viewcvs.cgi/*checkout*/trunk/1.8.x/ccs-patch/patches/ccs-patch-2.6.18-asianux-3.diff?root=tomoyo&revision=5551' || die "Can't download patch."
fi
