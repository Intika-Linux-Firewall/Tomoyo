...
if [ ! -r kernel-2.6.32-131.4.1.el6.src.rpm ]
then
    wget http://ftp.redhat.com/pub/redhat/linux/enterprise/6Server/en/os/SRPMS/kernel-2.6.32-131.4.1.el6.src.rpm || die "Can't download source package."
fi
rpm --checksig kernel-2.6.32-131.4.1.el6.src.rpm || die "Can't verify signature."
rpm -ivh kernel-2.6.32-131.4.1.el6.src.rpm || die "Can't install source package."
...
if [ ! -r ccs-patch-2.6.32-centos-6.1-20110520-1.8.1.diff ]
then
    wget -O ccs-patch-2.6.32-centos-6.1-20110520-1.8.1.diff 'http://sourceforge.jp/projects/tomoyo/svn/view/trunk/1.8.x/ccs-patch/patches/ccs-patch-2.6.32-centos-6.1.diff?revision=5041&root=tomoyo' || die "Can't download patch."
fi
...
+patch -sp1 < %_sourcedir/ccs-patch-2.6.32-centos-6.1-20110520-1.8.1.diff
+
