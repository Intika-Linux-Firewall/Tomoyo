...
if [ ! -r ccs-patch-2.6.38-fedora-15-20110526-1.8.1.diff ]
then
    wget -O ccs-patch-2.6.38-fedora-15-20110526-1.8.1.diff 'http://sourceforge.jp/projects/tomoyo/svn/view/trunk/1.8.x/ccs-patch/patches/ccs-patch-2.6.38-fedora-15.diff?revision=5059&root=tomoyo' || die "Can't download patch."
fi
...
+patch -sp1 < %_sourcedir/ccs-patch-2.6.38-fedora-15-20110526-1.8.1.diff
+
 %endif
