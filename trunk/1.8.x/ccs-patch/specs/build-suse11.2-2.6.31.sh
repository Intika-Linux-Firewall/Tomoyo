...
if [ ! -r ccs-patch-1.8.1-20110505.tar.gz ]
then
    wget -O ccs-patch-1.8.1-20110505.tar.gz 'http://sourceforge.jp/frs/redir.php?f=/tomoyo/49684/ccs-patch-1.8.1-20110505.tar.gz' || die "Can't download patch."
fi
...
+# TOMOYO Linux
+tar -zxf %_sourcedir/ccs-patch-1.8.1-20110505.tar.gz
