...
const u8 ccs_index2category[CCS_MAX_MAC_INDEX + CCS_MAX_CAPABILITY_INDEX] = {
	...
	[CCS_MAC_NETWORK_INET_TCP_BIND]          = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_INET_TCP_LISTEN]        = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_INET_TCP_CONNECT]       = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_INET_TCP_ACCEPT]        = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_INET_UDP_BIND]          = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_INET_UDP_CONNECT]       = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_INET_UDP_SEND]          = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_INET_UDP_RECV]          = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_INET_RAW_BIND]          = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_INET_RAW_CONNECT]       = CCS_MAC_CATEGORY_NETWORK,
	...
	[CCS_MAC_NETWORK_UNIX_DGRAM_CONNECT]     = CCS_MAC_CATEGORY_NETWORK,
