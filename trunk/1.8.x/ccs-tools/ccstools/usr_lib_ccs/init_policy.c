...
"# use 'Header[index]', 'Domain[index]', 'ACL[index]' for reffering index'th\n"
...
"# log when all preceding conditions in that chunk has matched.\n"
"# Note that an audit log is written to only first chunk which all\n"
"# conditions in that chunk has matched.\n"
"#\n"
...
"\n"
"# Save rejected logs with profile=0 to "
"/var/log/tomoyo/reject_000.log\n"
"Header.contains: profile=0\n"
"Destination: /var/log/tomoyo/reject_000.log\n"
"\n"
"# Save rejected logs with profile=1 to "
"/var/log/tomoyo/reject_001.log\n"
"Header.contains: profile=1\n"
"Destination: /var/log/tomoyo/reject_001.log\n"
"\n"
"# Save rejected logs with profile=2 to "
"/var/log/tomoyo/reject_002.log\n"
"Header.contains: profile=2\n"
"Destination: /var/log/tomoyo/reject_002.log\n"
"\n"
"# Save rejected logs with profile=3 to "
"/var/log/tomoyo/reject_003.log\n"
