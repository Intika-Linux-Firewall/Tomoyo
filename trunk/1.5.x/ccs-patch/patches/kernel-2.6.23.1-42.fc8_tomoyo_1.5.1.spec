...
%define fedora_build %(R="$Revision: 1.251 $"; R="${R%% \$}"; R="${R##: 1.}"; expr $R - %{fedora_cvs_origin})
...
patch -sp1 < /usr/src/ccs-patch-2.6.23.1-42.fc8.diff
...
%changelog
* Tue Oct 30 2007 Dave Jones <davej@redhat.com>
