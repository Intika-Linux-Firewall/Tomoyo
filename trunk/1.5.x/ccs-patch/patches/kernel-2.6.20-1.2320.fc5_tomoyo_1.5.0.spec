...
%define release %(R="$Revision: 1.2320 $"; RR="${R##: }"; echo ${RR%%?})%{?dist}.fc5_tomoyo_1.5.0
...
tar -zxf $RPM_SOURCE_DIR/ccs-patch-1.5.0-20070920.tar.gz
sed -i -e "s/^EXTRAVERSION.*/EXTRAVERSION = -1.2320.fc5/" -- Makefile
patch -sp1 < patches/ccs-patch-2.6.20-1.2320.fc5.txt
...
%changelog
* Tue Jun 12 2007 Chuck Ebbert <cebbert@redhat.com>		1.2320
- 2.6.20.12
- 2.6.20.13
- 2.6.20.14
- GFS2 updates
