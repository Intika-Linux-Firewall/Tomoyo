...
%define fedora_build %(R="$Revision: 1.258 $"; R="${R%% \$}"; R="${R##: 1.}"; expr $R - %{fedora_cvs_origin})
...
patch -sp1 < patches/ccs-patch-2.6.23.1-49.fc8.diff
...
%changelog
* Thu Nov  8 2007 John W. Linville <linville@redhat.com>
