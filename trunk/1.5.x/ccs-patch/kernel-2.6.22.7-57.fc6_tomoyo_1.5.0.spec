...
%define fedora_build %(R="$Revision: 1.3025 $"; R="${R%% \$}"; R="${R##: 1.}"; expr $R - %{fedora_cvs_origin})
...
sed -i -e 's:EXTRAVERSION =.*:EXTRAVERSION = .7-57.fc6:' -- Makefile
patch -sp1 < /usr/src/ccs-patch-2.6.22.7-57.fc6.txt
