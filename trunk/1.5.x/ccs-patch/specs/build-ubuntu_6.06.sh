...
then
    wget -O ccs-patch-2.6.15-ubuntu-6.06p1.diff 'http://svn.sourceforge.jp/cgi-bin/viewcvs.cgi/*checkout*/trunk/1.5.x/ccs-patch/patches/ccs-patch-2.6.15-ubuntu-6.06.diff?root=tomoyo'
fi
