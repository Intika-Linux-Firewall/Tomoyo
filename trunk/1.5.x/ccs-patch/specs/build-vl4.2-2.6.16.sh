...
+%define release 76.37%{_dist_release}_tomoyo_1.5.4
...
EOF
mv kernel-2.6-vl.spec kernel-2.6.16-76.37vl4_tomoyo_1.5.4.spec || die "Can't rename spec file."
echo ""
echo ""
echo ""
echo "Edit /tmp/kernel-2.6.16-76.37vl4_tomoyo_1.5.4.spec if needed, and run"
echo "rpmbuild -bb /tmp/kernel-2.6.16-76.37vl4_tomoyo_1.5.4.spec"
