...
then
    wget -O ccs-patch-2.6.18-53.1.21.el5.diff 'http://svn.sourceforge.jp/cgi-bin/viewcvs.cgi/*checkout*/trunk/1.6.x/ccs-patch/patches/ccs-patch-2.6.18-53.1.21.el5.diff?root=tomoyo' || die "Can't download patch."
fi
...
+  sed -i -e "s/CONFIG_DEBUG_INFO=.*/# CONFIG_DEBUG_INFO is not set/" -- .config
   ...
   echo "# $Arch" > configs/$i
EOF
mv kernel-2.6.spec kernel-2.6.18-53.1.21.el5_tomoyo_1.6.1.spec || die "Can't rename spec file."
echo ""
echo ""
echo ""
echo "Edit /tmp/kernel-2.6.18-53.1.21.el5_tomoyo_1.6.1.spec if needed, and run"
echo "rpmbuild -bb --without kabichk /tmp/kernel-2.6.18-53.1.21.el5_tomoyo_1.6.1.spec"
