...
if [ ! -r kernel-2.6.9-78.0.17.EL.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/centos/4.7/updates/SRPMS/kernel-2.6.9-78.0.17.EL.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.9-78.0.17.EL.src.rpm || die "Can't install source package."
...
--- kernel-2.6.spec	2009-03-13 07:27:24.000000000 +0900
+++ kernel-2.6.spec	2009-04-21 09:13:42.000000000 +0900
@@ -27,7 +27,7 @@
 # that the kernel isn't the stock distribution kernel, for example by
 # adding some text to the end of the version number.
 #
-%define release 78.0.17.EL
+%define release 78.0.17.EL_tomoyo_1.6.7p1
 %define sublevel 9
