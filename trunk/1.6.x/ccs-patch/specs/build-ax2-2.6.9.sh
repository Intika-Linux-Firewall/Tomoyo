...
then
    wget -O ccs-patch-2.6.9-asianux-2.diff 'http://svn.sourceforge.jp/cgi-bin/viewcvs.cgi/*checkout*/trunk/1.6.x/ccs-patch/patches/ccs-patch-2.6.9-asianux-2.diff?root=tomoyo' || die "Can't download patch."
fi
...
+%define release 42.24AX%{axbsys}_tomoyo_1.6.3
 %define sublevel 9
