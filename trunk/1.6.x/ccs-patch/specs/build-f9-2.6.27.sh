...
if [ ! -r kernel-2.6.27.21-78.2.41.fc9.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/fedora/updates/9/SRPMS.newkey/kernel-2.6.27.21-78.2.41.fc9.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.27.21-78.2.41.fc9.src.rpm || die "Can't install source package."
...
--- kernel.spec	2009-03-24 12:04:51.000000000 +0900
+++ kernel.spec	2009-04-03 14:04:19.000000000 +0900
@@ -12,7 +12,7 @@
