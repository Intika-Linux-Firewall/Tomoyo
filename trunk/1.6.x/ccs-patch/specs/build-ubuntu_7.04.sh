...
apt-get build-dep linux-restricted-modules-2.6.20-16-generic
apt-get source linux-restricted-modules-2.6.20-16-generic
...
patch -p1 < patches/ccs-patch-2.6.20.3-ubuntu1.diff
...
dpkg -i debian/build/linux-headers-2.6.20-16*.deb
cd /usr/src/linux-restricted-modules-2.6.20-2.6.20.6/
