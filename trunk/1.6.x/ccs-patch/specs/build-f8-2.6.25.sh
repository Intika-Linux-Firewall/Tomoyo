...
+patch -sp1 < patches/ccs-patch-2.6.25.4-10.fc8.diff
+
 %endif
...
+  sed -i -e 's:CONFIG_DEBUG_INFO=.*:# CONFIG_DEBUG_INFO is not set:' -- .config
   ...
   echo "# $Arch" > configs/$i
EOF
mv kernel.spec kernel-2.6.25.4-10.fc8_tomoyo_1.6.2.spec || die "Can't rename spec file."
echo ""
echo ""
echo ""
echo "Edit /tmp/kernel-2.6.25.4-10.fc8_tomoyo_1.6.2.spec if needed, and run"
echo "rpmbuild -bb /tmp/kernel-2.6.25.4-10.fc8_tomoyo_1.6.2.spec"
