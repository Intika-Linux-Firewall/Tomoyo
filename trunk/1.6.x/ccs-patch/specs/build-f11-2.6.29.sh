...
if [ ! -r kernel-2.6.29.3-140.fc11.src.rpm ]
then
    wget http://mirrors.kernel.org/fedora/development/source/SRPMS/kernel-2.6.29.3-140.fc11.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.29.3-140.fc11.src.rpm || die "Can't install source package."
...
--- ccs-kernel.spec	2009-05-12 23:22:50.000000000 +0900
+++ ccs-kernel.spec	2009-05-18 10:51:30.000000000 +0900
@@ -12,7 +12,7 @@
