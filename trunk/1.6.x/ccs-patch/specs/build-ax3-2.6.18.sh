...
if [ ! -r ccs-patch-1.6.9-20171111.tar.gz ]
then
    wget -O ccs-patch-1.6.9-20171111.tar.gz 'https://osdn.jp/frs/redir.php?f=/tomoyo/30297/ccs-patch-1.6.9-20171111.tar.gz' || die "Can't download patch."
fi
...
+# TOMOYO Linux
+tar -zxf %_sourcedir/ccs-patch-1.6.9-20171111.tar.gz
