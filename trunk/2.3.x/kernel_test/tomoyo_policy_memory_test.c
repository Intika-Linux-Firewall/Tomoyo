...
static const char *domain_testcases[] = {
	...
	"allow_create /tmp/open_test 0600 if 0=task.uid",
	"allow_create /tmp/open_test 0600 if 0=0",
	"allow_create /tmp/open_test 0600",
	"allow_execute /bin/true if task.uid!=10 0=0",
	...
	"allow_mkfifo /tmp/mknod_fifo_test 0600 if 0=01777 "
	"0=0123 0=0 0=0",
	"allow_mkfifo /tmp/mknod_fifo_test 0600",
	"allow_mksock /tmp/mknod_sock_test 0600",
	"allow_mksock /tmp/socket_test 0600",
	"allow_read /bin/true if 0=0 0=0 10=10-100",
	"allow_read /bin/true",
	"allow_read /dev/null if 0=0",
	"allow_read /dev/null if 0!=0777",
	"allow_read /dev/null if 0=0666",
	"allow_read /dev/null if 0!=01234 0!=012345 0!=0123",
	"allow_read /dev/null if 0=12345678 1=1 1=3",
	"allow_read /dev/null",
	"allow_read /foo",
	...
	"allow_read/write /dev/null if task.uid=0",
	...
	"allow_read/write /tmp/fifo if 0=1234",
	...
	"allow_mount /dev/sda1 /mnt/sda1/ ext3 0x123 if 0=0",
	"allow_mount /dev/sda1 /mnt/sda1/ ext3 123 if 0=task.uid",
	"allow_mount /dev/sda1 /mnt/sda1/ ext3 0123 if 0=@uid",
	"allow_chroot /",
	"allow_chroot / if task.uid=123-456",
	"allow_chroot /mnt/ if task.uid=123-456 0=0",
	"allow_pivot_root / /proc/ if 0!=0",
	"allow_pivot_root /mnt/ /proc/mnt/ if 0!=0 0=150",
	"allow_unmount / if 0!=0",
	"allow_unmount /proc/ if 0!=0",
	NULL
};
