...
%define release %(R="$Revision: 1.2300 $"; RR="${R##: }"; echo ${RR%%?})%{?dist}.fc5_tomoyo_1.3.3
...
Patch1794: linux-2.6-20_ia64_chip_mask.patch
...
# TOMOYO Linux
tar -zxf $RPM_SOURCE_DIR/ccs-patch-1.3.3-20070401.tar.gz
sed -i -e "s/^EXTRAVERSION.*/EXTRAVERSION = -1.2300.fc5/" -- Makefile
patch -sp1 < ccs-patch-2.6.20-1.2300.fc5.txt
...
%changelog
* Sun Mar 11 2007 Chuck Ebbert <cebbert@redhat.com>
- 2.6.20.2
- 2.6.20.3-rc1
- removed (now in -stable):
