...
%define release %(R="$Revision: 1.2925 $"; RR="${R##: }"; echo ${RR%%?})%{?dist}.fc6_tomoyo_1.3.3
...
sed -i -e "s/^EXTRAVERSION =.*/EXTRAVERSION = -1.2925.fc6/" -- Makefile
patch -sp1 < ccs-patch-2.6.20-1.2925.fc6.txt
