...
if [ ! -r kernel-2.6.31.12-174.2.22.fc12.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/fedora/updates/12/SRPMS/kernel-2.6.31.12-174.2.22.fc12.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.31.12-174.2.22.fc12.src.rpm || die "Can't install source package."
...
--- ccs-kernel.spec	2010-02-20 03:26:07.000000000 +0900
+++ ccs-kernel.spec	2010-02-22 04:52:46.922194348 +0900
@@ -15,7 +15,7 @@
