...
if [ ! -r kernel-2.6.18-128.14.AXS3.src.rpm ]
then
    wget http://ftp.miraclelinux.com/pub/Asianux/Server/3.0/updates/src/kernel-2.6.18-128.14.AXS3.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.18-128.14.AXS3.src.rpm || die "Can't install source package."
...
--- kernel-2.6.spec	2010-03-02 11:06:31.000000000 +0900
+++ kernel-2.6.spec	2010-03-20 17:44:00.000000000 +0900
@@ -68,7 +68,7 @@
 %define sublevel 18
 %define kversion 2.6.%{sublevel}
 %define rpmversion 2.6.%{sublevel}
-%define release 128.14%{?dist}
+%define release 128.14%{?dist}_tomoyo_1.7.1p3
