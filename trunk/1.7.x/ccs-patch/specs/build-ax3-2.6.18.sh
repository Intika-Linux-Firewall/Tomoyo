...
if [ ! -r ccs-patch-1.7.3-20120401.tar.gz ]
then
    wget -O ccs-patch-1.7.3-20120401.tar.gz 'http://sourceforge.jp/frs/redir.php?f=/tomoyo/43375/ccs-patch-1.7.3-20120401.tar.gz' || die "Can't download patch."
fi
...
+%define release %{revision}.6%{dist}_tomoyo_1.7.3p3
...
+# TOMOYO Linux
+tar -zxf %_sourcedir/ccs-patch-1.7.3-20120401.tar.gz
