...
if [ ! -r ccs-patch-1.7.3-20130117.tar.gz ]
then
    wget -O ccs-patch-1.7.3-20130117.tar.gz 'http://sourceforge.jp/frs/redir.php?f=/tomoyo/43375/ccs-patch-1.7.3-20130117.tar.gz' || die "Can't download patch."
fi
...
+%define release %{revision}.7%{dist}_tomoyo_1.7.3p4
...
+# TOMOYO Linux
+tar -zxf %_sourcedir/ccs-patch-1.7.3-20130117.tar.gz
