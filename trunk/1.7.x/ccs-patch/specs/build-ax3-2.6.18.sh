...
if [ ! -r kernel-2.6.18-274.6.AXS3.src.rpm ]
then
    wget http://ftp.miraclelinux.com/pub/Asianux/Server/3.0/updates/src/kernel-2.6.18-274.6.AXS3.src.rpm || die "Can't download source package."
fi
rpm --checksig kernel-2.6.18-274.6.AXS3.src.rpm || die "Can't verify signature."
rpm -ivh kernel-2.6.18-274.6.AXS3.src.rpm || die "Can't install source package."
...
+%define release %{revision}.6%{dist}_tomoyo_1.7.3p2
