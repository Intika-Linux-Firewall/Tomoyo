...
if [ ! -r kernel-2.6.30.8-64.fc11.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/fedora/updates/11/SRPMS/kernel-2.6.30.8-64.fc11.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.30.8-64.fc11.src.rpm || die "Can't install source package."
...
--- ccs-kernel.spec	2009-09-25 17:19:51.000000000 +0900
+++ ccs-kernel.spec	2009-09-30 13:09:43.513699852 +0900
@@ -15,7 +15,7 @@
