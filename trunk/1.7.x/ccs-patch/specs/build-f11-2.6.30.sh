...
if [ ! -r kernel-2.6.30.9-90.fc11.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/fedora/updates/11/SRPMS/kernel-2.6.30.9-90.fc11.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.30.9-90.fc11.src.rpm || die "Can't install source package."
...
--- ccs-kernel.spec	2009-10-18 00:02:30.000000000 +0900
+++ ccs-kernel.spec	2009-10-29 12:15:18.045973212 +0900
@@ -15,7 +15,7 @@
