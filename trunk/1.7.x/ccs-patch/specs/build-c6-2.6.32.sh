...
if [ ! -r kernel-2.6.32-642.4.2.el6.src.rpm ]
then
    wget http://vault.centos.org/6.8/updates/Source/SPackages/kernel-2.6.32-642.4.2.el6.src.rpm || die "Can't download source package."
fi
