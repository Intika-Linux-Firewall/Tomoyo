...
if [ ! -r kernel-source-2.6.31.14-0.2.1.src.rpm ]
then
    wget http://download.opensuse.org/update/11.2/rpm/src/kernel-source-2.6.31.14-0.2.1.src.rpm || die "Can't download source package."
fi
rpm --checksig kernel-source-2.6.31.14-0.2.1.src.rpm || die "Can't verify signature."
rpm -ivh kernel-source-2.6.31.14-0.2.1.src.rpm || die "Can't install source package."

if [ ! -r kernel-default-2.6.31.14-0.2.1.nosrc.rpm ]
then
    wget http://download.opensuse.org/update/11.2/rpm/src/kernel-default-2.6.31.14-0.2.1.nosrc.rpm || die "Can't download source package."
fi
rpm --checksig kernel-default-2.6.31.14-0.2.1.nosrc.rpm || die "Can't verify signature."
rpm -ivh kernel-default-2.6.31.14-0.2.1.nosrc.rpm || die "Can't install source package."
