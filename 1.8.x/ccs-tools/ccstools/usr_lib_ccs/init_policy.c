...
static void make_profile(void)
{
	...
	fprintf(fp,
		...
		"reject_log=no }\n"
		"0-PREFERENCE::audit={ max_grant_log=0 max_reject_log=0 "
		"task_info=no path_info=no }\n"
		"0-PREFERENCE::learning={ max_entry=0 exec.realpath=no "
		"exec.argv0=no symlink.target=no }\n"
		"0-PREFERENCE::enforcing={ penalty=0 }\n"
		"1-COMMENT=-----Learning Mode-----\n"
		"1-CONFIG%s={ mode=learning verbose=no grant_log=yes "
		"reject_log=yes }\n"
		"1-PREFERENCE::audit={ max_grant_log=1024 max_reject_log=1024 "
		"task_info=yes path_info=yes }\n"
		"1-PREFERENCE::learning={ max_entry=2048 exec.realpath=yes "
		"exec.argv0=yes symlink.target=yes }\n"
		"1-PREFERENCE::enforcing={ penalty=0 }\n"
		"2-COMMENT=-----Permissive Mode-----\n"
		"2-CONFIG%s={ mode=permissive verbose=yes grant_log=yes "
		"reject_log=yes }\n"
		"2-PREFERENCE::audit={ max_grant_log=1024 max_reject_log=1024 "
		"task_info=yes path_info=yes }\n"
		"2-PREFERENCE::learning={ max_entry=0 exec.realpath=no "
		"exec.argv0=no symlink.target=no }\n"
		"2-PREFERENCE::enforcing={ penalty=0 }\n"
		"3-COMMENT=-----Enforcing Mode-----\n"
		"3-CONFIG%s={ mode=enforcing verbose=yes grant_log=yes "
		"reject_log=yes }\n"
		"3-PREFERENCE::audit={ max_grant_log=1024 max_reject_log=1024 "
		"task_info=yes path_info=yes }\n"
		"3-PREFERENCE::learning={ max_entry=0 exec.realpath=no "
		"exec.argv0=no symlink.target=no }\n"
		"3-PREFERENCE::enforcing={ penalty=0 }\n",
