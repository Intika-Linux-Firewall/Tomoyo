...
if [ ! -r kernel-2.6.43.5-2.fc15.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/fedora/updates/15/SRPMS/kernel-2.6.43.5-2.fc15.src.rpm || die "Can't download source package."
fi
rpm --checksig kernel-2.6.43.5-2.fc15.src.rpm || die "Can't verify signature."
rpm -ivh kernel-2.6.43.5-2.fc15.src.rpm || die "Can't install source package."
