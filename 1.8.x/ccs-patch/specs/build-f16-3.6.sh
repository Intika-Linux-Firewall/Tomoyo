#! /bin/sh
#
# This is a kernel build script for Fedora 16's 3.6 kernel.
#
...
if [ ! -r kernel-3.6.11-4.fc16.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/fedora/updates/16/SRPMS/kernel-3.6.11-4.fc16.src.rpm || die "Can't download source package."
fi
rpm --checksig kernel-3.6.11-4.fc16.src.rpm || die "Can't verify signature."
rpm -ivh kernel-3.6.11-4.fc16.src.rpm || die "Can't install source package."
...
+patch -sp1 < patches/ccs-patch-3.6-fedora-16.diff
+
 %endif
