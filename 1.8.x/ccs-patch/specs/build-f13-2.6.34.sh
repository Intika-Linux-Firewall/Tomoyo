...
if [ ! -r kernel-2.6.34.9-69.fc13.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/fedora/updates/13/SRPMS/kernel-2.6.34.9-69.fc13.src.rpm || die "Can't download source package."
fi
rpm --checksig kernel-2.6.34.9-69.fc13.src.rpm || die "Can't verify signature."
rpm -ivh kernel-2.6.34.9-69.fc13.src.rpm || die "Can't install source package."
