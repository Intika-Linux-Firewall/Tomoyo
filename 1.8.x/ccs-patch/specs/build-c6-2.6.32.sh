...
if [ ! -r kernel-2.6.32-71.18.2.el6.src.rpm ]
then
    wget http://ftp.redhat.com/pub/redhat/linux/enterprise/6Server/en/os/SRPMS/kernel-2.6.32-71.18.2.el6.src.rpm || die "Can't download source package."
fi
rpm --checksig kernel-2.6.32-71.18.2.el6.src.rpm || die "Can't verify signature."
rpm -ivh kernel-2.6.32-71.18.2.el6.src.rpm || die "Can't install source package."
