...
if [ ! -r kernel-source-3.4.11-2.16.1.src.rpm ]
then
    wget http://download.opensuse.org/update/12.2/src/kernel-source-3.4.11-2.16.1.src.rpm || die "Can't download source package."
fi
rpm --checksig kernel-source-3.4.11-2.16.1.src.rpm || die "Can't verify signature."
rpm -ivh kernel-source-3.4.11-2.16.1.src.rpm || die "Can't install source package."

if [ ! -r kernel-default-3.4.11-2.16.1.nosrc.rpm ]
then
    wget http://download.opensuse.org/update/12.2/nosrc/kernel-default-3.4.11-2.16.1.nosrc.rpm || die "Can't download source package."
fi
rpm --checksig kernel-default-3.4.11-2.16.1.nosrc.rpm || die "Can't verify signature."
rpm -ivh kernel-default-3.4.11-2.16.1.nosrc.rpm || die "Can't install source package."

cd /usr/src/packages/SOURCES/ || die "Can't chdir to /usr/src/packages/SOURCES/ ."
if [ ! -r ccs-patch-1.8.3-20130117.tar.gz ]
then
    wget -O ccs-patch-1.8.3-20130117.tar.gz 'http://sourceforge.jp/frs/redir.php?f=/tomoyo/49684/ccs-patch-1.8.3-20130117.tar.gz' || die "Can't download patch."
fi
...
+# TOMOYO Linux
+tar -zxf %_sourcedir/ccs-patch-1.8.3-20130117.tar.gz
