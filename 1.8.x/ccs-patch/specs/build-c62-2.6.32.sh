...
if [ ! -r ccs-patch-2.6.32-centos-6.2-1.8.3-20111207.diff ]
then
    wget -O ccs-patch-2.6.32-centos-6.2-1.8.3-20111207.diff 'http://sourceforge.jp/projects/tomoyo/svn/view/trunk/1.8.x/ccs-patch/patches/ccs-patch-2.6.32-centos-6.2.diff?view=co&revision=5689&root=tomoyo'
fi
...
+patch -sp1 < %_sourcedir/ccs-patch-2.6.32-centos-6.2-1.8.3-20111207.diff
+
