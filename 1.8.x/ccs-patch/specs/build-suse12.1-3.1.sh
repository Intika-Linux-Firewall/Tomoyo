...
if [ ! -r kernel-source-3.1.10-1.13.1.src.rpm ]
then
    wget http://download.opensuse.org/update/12.1/src/kernel-source-3.1.10-1.13.1.src.rpm || die "Can't download source package."
fi
rpm --checksig kernel-source-3.1.10-1.13.1.src.rpm || die "Can't verify signature."
rpm -ivh kernel-source-3.1.10-1.13.1.src.rpm || die "Can't install source package."

if [ ! -r kernel-default-3.1.10-1.13.1.nosrc.rpm ]
then
    wget http://download.opensuse.org/update/12.1/nosrc/kernel-default-3.1.10-1.13.1.nosrc.rpm || die "Can't download source package."
fi
rpm --checksig kernel-default-3.1.10-1.13.1.nosrc.rpm || die "Can't verify signature."
rpm -ivh kernel-default-3.1.10-1.13.1.nosrc.rpm || die "Can't install source package."
