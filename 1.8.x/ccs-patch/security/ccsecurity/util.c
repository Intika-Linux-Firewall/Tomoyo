...
const u8 ccs_index2category[CCS_MAX_MAC_INDEX + CCS_MAX_CAPABILITY_INDEX] = {
	...
	[CCS_MAC_NETWORK_UDP_SEND]    = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_UDP_RECV]    = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_RAW_BIND]    = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_RAW_SEND]    = CCS_MAC_CATEGORY_NETWORK,
	[CCS_MAC_NETWORK_RAW_RECV]    = CCS_MAC_CATEGORY_NETWORK,
