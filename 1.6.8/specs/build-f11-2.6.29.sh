...
if [ ! -r kernel-2.6.29.4-162.fc11.src.rpm ]
then
    wget http://mirrors.kernel.org/fedora/development/source/SRPMS/kernel-2.6.29.4-162.fc11.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.29.4-162.fc11.src.rpm || die "Can't install source package."
...
--- ccs-kernel.spec	2009-05-26 05:31:34.000000000 +0900
+++ ccs-kernel.spec	2009-05-28 10:15:30.000000000 +0900
@@ -12,7 +12,7 @@
