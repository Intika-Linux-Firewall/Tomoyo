...
This program is an agent for B<tomoyo-editpolicy>, B<tomoyo-loadpolicy>, B<tomoyo-savepolicy>, B<tomoyo-pstree>, and B<tomoyo-queryd>.
...
B<tomoyo-editpolicy>(8), B<tomoyo-loadpolicy>(8), B<tomoyo-savepolicy>(8), B<tomoyo-pstree>(8), B<tomoyo-queryd>(8)
