...
if [ ! -r kernel-2.6.27.21-170.2.56.fc10.src.rpm ]
then
    wget http://ftp.riken.jp/Linux/fedora/development/source/SRPMS/kernel-2.6.27.21-170.2.56.fc10.src.rpm || die "Can't download source package."
fi
rpm -ivh kernel-2.6.27.21-170.2.56.fc10.src.rpm || die "Can't install source package."
...
--- kernel.spec	2009-03-24 11:49:08.000000000 +0900
+++ kernel.spec	2009-04-03 11:10:05.000000000 +0900
@@ -12,7 +12,7 @@
