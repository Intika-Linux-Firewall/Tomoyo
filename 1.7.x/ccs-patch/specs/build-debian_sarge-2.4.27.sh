...
tar -zxf /usr/src/rpm/SOURCES/ccs-patch-1.7.0-20090903.tar.gz config.ccs || die "Can't extract patch."
...
tar -zxf /usr/src/rpm/SOURCES/ccs-patch-1.7.0-20090903.tar.gz || die "Can't extract patch."
