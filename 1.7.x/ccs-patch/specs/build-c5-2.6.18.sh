...
if [ ! -r kernel-2.6.18-274.12.1.el5.src.rpm ]
then
    wget http://vault.centos.org/5.7/updates/SRPMS/kernel-2.6.18-274.12.1.el5.src.rpm || die "Can't download source package."
fi
rpm --checksig kernel-2.6.18-274.12.1.el5.src.rpm || die "Can't verify signature."
rpm -ivh kernel-2.6.18-274.12.1.el5.src.rpm || die "Can't install source package."
