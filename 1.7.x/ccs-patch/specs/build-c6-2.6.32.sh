...
if [ ! -r ccs-patch-2.6.32-centos-6.0-1.7.2-20110113.diff ]
then
    wget -O ccs-patch-2.6.32-centos-6.0-1.7.2-20110113.diff 'http://sourceforge.jp/projects/tomoyo/svn/view/trunk/1.7.x/ccs-patch/patches/ccs-patch-2.6.32-centos-6.0.diff?root=tomoyo&revision=4352&content-type=text%2Fplain'
fi
...
+patch -sp1 < %_sourcedir/ccs-patch-2.6.32-centos-6.0-1.7.2-20110113.diff
+
