...
rpm --checksig kernel-2.6.9-100.EL.src.rpm || die "Can't verify signature."
...
if [ ! -r ccs-patch-2.6.9-centos-4.9-1.7.2-20110217.diff ]
then
    wget -O ccs-patch-2.6.9-centos-4.9-1.7.2-20110217.diff 'http://sourceforge.jp/projects/tomoyo/svn/view/trunk/1.7.x/ccs-patch/patches/ccs-patch-2.6.9-centos-4.9.diff?root=tomoyo&revision=4675' || die "Can't download patch."
fi
...
+%define release 100.EL_tomoyo_1.7.2p4
 %define sublevel 9
...
+patch -sp1 < %_sourcedir/ccs-patch-2.6.9-centos-4.9-1.7.2-20110217.diff
+
