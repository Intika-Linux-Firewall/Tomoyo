...
static struct {
	...
	{ "MAX_ACCEPT_FILES",    MAX_ACCEPT_FILES, UINT_MAX },     // CCS_TOMOYO_MAX_ACCEPT_FILES
	{ "MAX_GRANT_LOG",       MAX_GRANT_LOG, MAX_GRANT_LOG },   // CCS_TOMOYO_MAX_GRANT_LOG
	{ "MAX_REJECT_LOG",      MAX_REJECT_LOG, MAX_REJECT_LOG }, // CCS_TOMOYO_MAX_REJECT_LOG
...
void CCS_LoadPolicy(const char *filename)
{
	...
	LoadPolicyManager();
#ifdef CONFIG_SAKURA
	printk("SAKURA: 1.1.1   2006/05/15\n");
	printk("SAKURA is loading policy. Please wait.\n");
	LoadSystemPolicy();
#endif
#ifdef CONFIG_TOMOYO
	printk("TOMOYO: 1.1.1   2006/05/15\n");
