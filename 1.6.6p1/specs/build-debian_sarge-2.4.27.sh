...
tar -zxf /usr/src/rpm/SOURCES/ccs-patch-1.6.6-20090314.tar.gz config.ccs || die "Can't extract patch."
...
tar -zxf /usr/src/rpm/SOURCES/ccs-patch-1.6.6-20090314.tar.gz || die "Can't extract patch."
